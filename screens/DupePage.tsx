...
const DupePage = () => {
  return (
    <View style={styles.dupePage}>
      <LinearGradient
        style={styles.dupePageChild}
        locations={[0, 1]}
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/solsticeremovebgpreview-11.png")}
      />
      <View style={styles.tettaParent}>
        <Text style={[styles.tetta, styles.tettaTypo]}>Tetta</Text>
        <Text style={[styles.hello, styles.helloTypo]}>{`Hello,
`}</Text>
      </View>
      <Text style={[styles.topLeaderboard, styles.tettaTypo]}>
        Top Leaderboard
      </Text>
      ...
      <Image
        style={[styles.dupePageInner, styles.dupePageInnerPosition]}
        contentFit="cover"
      ...
      <View style={[styles.tetta1, styles.tettaLayout]}>
      ...
      <Image
        style={[styles.groupIcon, styles.tettaLayout]}
        contentFit="cover"
